 ...
 * @author spkot
 */
public class StudentStationeryJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form StudentStationeryJPanel
     */
    public StudentStationeryJPanel(JPanel userProcessContainer, Student student, EcoSystem system, UserAccount userAccount, Enterprise enterprise, Network network) {
        initComponents();
        ...
        populateStationeryInventoryItems();
        populateRequests();
    }

    private void populateStationeryInventoryItems() {
        ...
        for (Network net : business.getNetworkList()) {
            for (Enterprise e : net.getEnterpriseDirectory().getEnterpriseList()) {
                if (e.getStationeryInventoryList() == null) {
                    continue;
                }
                for (Items i : e.getStationeryInventoryList()) {
        ...
        for (Network net : business.getNetworkList()) {
            for (Enterprise e : net.getEnterpriseDirectory().getEnterpriseList()) {
                for (Organization o : e.getOrganizationDirectory().getOrganizationList()) {
                    if (!(o instanceof StationeryStoreOrganization)) {
                        continue;
                    }
                    for (WorkRequest request : o.getWorkQueue().getWorkRequestList()) {
                        ...
                        if (request.getSender().getStudent().equals(this.student)) {
                            ...
                            row[2] = request;
                            row[3] = ((StationeryStoreWorkRequest) request).getTotalBill();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(163, 163, 163)
                        .addComponent(addToCartBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        tabbedPaneCustom1.addTab("Order Stationery", jPanel2);
        ...
        add(tabbedPaneCustom1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-5, 139, 1090, 500));
    ...
    private void placeOrderBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_placeOrderBtnActionPerformed
        ...
        if (invoiceTbl.getRowCount() > 0 && cartCount > 0) {
            StationeryStoreWorkRequest request = new StationeryStoreWorkRequest();
            request.setStationeryRequestList(cusList);
                ...
                for (Enterprise enter : net.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enter instanceof CollegeStoreEnterprise) {
                        for (Organization organization : enter.getOrganizationDirectory().getOrganizationList()) {
                            if (organization instanceof StationeryStoreOrganization) {
                                org = organization;
                                break;
                            }
                        }
