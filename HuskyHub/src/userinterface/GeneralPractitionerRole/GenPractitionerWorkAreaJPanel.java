...
public class GenPractitionerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 510, -1, 40));
        ...
        add(nameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 150, 30));

        jLabel5.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Age:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 350, 90, 30));

        txtAge.setEditable(false);
        txtAge.setBackground(new java.awt.Color(204, 255, 204));
        txtAge.setForeground(new java.awt.Color(51, 51, 51));
        add(txtAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 150, 30));
        ...
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 390, 107, 20));

        radioMale.setBackground(new java.awt.Color(0, 51, 51));
        radioMale.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        radioMale.setForeground(new java.awt.Color(102, 255, 255));
        ...
        add(radioMale, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 390, 68, -1));

        radioFemale.setBackground(new java.awt.Color(0, 51, 51));
        radioFemale.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        radioFemale.setForeground(new java.awt.Color(102, 255, 255));
        ...
        add(radioFemale, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 390, 72, -1));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 300, 86, 30));

        txtHeight.setEditable(false);
        txtHeight.setBackground(new java.awt.Color(204, 255, 204));
        txtHeight.setForeground(new java.awt.Color(51, 51, 51));
        add(txtHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 300, 150, 30));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 340, -1, 30));

        txtWeight.setEditable(false);
        txtWeight.setBackground(new java.awt.Color(204, 255, 204));
        txtWeight.setForeground(new java.awt.Color(51, 51, 51));
        add(txtWeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 340, 150, 30));

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(102, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Message:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 380, 110, 50));

        doctorMsgTxt.setBackground(new java.awt.Color(204, 255, 204));
        doctorMsgTxt.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        doctorMsgTxt.setForeground(new java.awt.Color(51, 51, 51));
        add(doctorMsgTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 390, 296, 80));
        ...
        add(viewDetailsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 510, 138, 45));
