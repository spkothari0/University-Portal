...
public class ManageVendorsJPanel extends javax.swing.JPanel {
    ...
    public ManageVendorsJPanel(JPanel upc, SupplierDirectory sd) {
        initComponents();
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        AddVendorJPanel as = new AddVendorJPanel(userProcessContainer, supplierDirectory);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        ViewVendorJPanel vs = new ViewVendorJPanel(userProcessContainer, s);
